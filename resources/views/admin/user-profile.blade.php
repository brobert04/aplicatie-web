                        ...
                        <div class="card-body box-profile">
                            ...
                            <div class="form-group" id="password-input1" hidden>
                                <label for="actual-password">Parola actuală</label>
                                    <input type="password" class="form-control @error('password') is-invalid @enderror"
                                           name="password" id="password" data-toggle="password" placeholder="Parolă actuală">
                                @error('password') <span class="text-danger small">{{$message}}</span>@enderror
                            </div>
                            <div class="form-group" id="password-input2" hidden>
                                <label for="newpassword">Parola nouă</label>
                                    <input type="password" class="form-control @error('password-new') is-invalid @enderror"
                                           name="newpassword" id="password" placeholder="Parolă nouă" data-toggle="password">
                            ...
                            <div class="form-group" id="password-input3" hidden>
                                ...
                                <input type="password"
                                       ...
                                       placeholder="Confirmare Parolă" data-toggle="password">
                            ...
                            <button id="cancel" class="btn btn-danger btn-block" hidden>Anulează</button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="settings">
                                    <form method="POST" action="{{route('users.edit-profile')}}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="name" type="text"
                                                       ...
                                                       id="name" placeholder="Nume și prenume" value="{{$user->name}}">
                                                @error('name') <span
                                                    class="text-danger small">{{$message}}</span>@enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="phone_number" class="col-sm-2 col-form-label">Număr de
                                                telefon</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="phone_number"
                                                       class="form-control @error('phone_number') is-invalid @enderror"
                                                       id="phone_number" placeholder="Număr de telefon"
                                                       value="{{$user->phone}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="address" type="text"
                                                       ...
                                                       id="address" placeholder="Adresă" value="{{$user->address}}">
                                                @error('address') <span
                                                    class="text-danger small">{{$message}}</span>@enderror
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputSkills" class="col-sm-2 col-form-label">Poza de
                                                profil</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="profile_photo">Alege
                                                        imaginea</label>
                                                </div>
...
@section('custom-js')
    ...
    <script>
        ...
        let info = document.getElementById('info_profile')
        ...
        cancelBtn.addEventListener('click', function(){
            inputOne.setAttribute('hidden', true);
            inputTwo.setAttribute('hidden', true);
            changeBtn.setAttribute('hidden', true);
            space.setAttribute('hidden', true);
            inputThree.setAttribute('hidden', true);
