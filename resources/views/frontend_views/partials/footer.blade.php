        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="d-flex justify-content-between">
                    <img src="../frontend/assets/images/logo.svg" class="footer-logo" alt="" />
            ...
            <div class="col-sm-12">
                ...
                >
                    ...
                    <p class="font-weight-medium">
                        © {{date('Y')}} <a href="https://www.bootstrapdash.com/" target="_blank" class="text-dark">@ WORLDNEWS</a>, Inc.All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
